<template>
    <div>
        ...
        <div class="mb-8">
            <div>
                <h3 class="mb-4">Разделы</h3>
            </div>
            <div v-for="branch in branch.children" class="flex items-center">
                <Link :href="route('branches.show', branch.id)" class="block bg-white p-4 border border-gray-300 w-full">
                    <div>
        ...
        <div>
            <div>
                <h3 class="my-4">Темы</h3>
            </div>
            <div v-for="theme in branch.themes" class="flex items-center">
                <Link :href="route('branches.show', theme.id)" class="block bg-white p-4 border border-gray-300 w-full">
